...
export default class Home extends H12 {
    ...
    async render() {
        return <>
            <div class="w-full h-full flex flex-col items-start justify-center space-y-4 p-6 md:p-12">
                ...
                <div class="flex space-x-2">
                    <button class="p-2 px-4 md:px-6 text-xs rounded-md bg-blue-500 font-semibold hover:bg-blue-600 active:bg-blue-700 transition-colors" onclick={ this.OpenDashboard }>Open Dashboard</button>
                </div>
            </div>
        </>;
    }
